...
<div id="ddu" class="easyui-panel">
	<form id="ff">
		...
		<div style="text-align:center;padding:5px 0">
			<a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitForm_updateStu()" style="width:80px">提交</a>
